...
const char* const iof_approach[] = {
    "",
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "Low"),
    ...
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "Needle leaved"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "Broad leaved"),
...
const char* const iof_location[] = {
    ...
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "Beneath"),
    ...
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "N side"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "NE side"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "E side"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "SE side"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "S side"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "SW side"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "W side"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "NW side"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "N part"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "NE part"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "E part"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "SE part"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "S part"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "SW part"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "W part"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "NW part"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "N edge"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "NE edge"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "E edge"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "SE edge"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "S edge"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "SW edge"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "W edge"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "NW edge"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "Corner (inside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "N corner (inside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "NE corner (inside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "E corner (inside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "SE corner (inside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "S corner (inside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "SW corner (inside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "W corner (inside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "NW corner (inside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "Corner (outside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "N corner (outside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "NE corner (outside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "E corner (outside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "SE corner (outside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "S corner (outside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "SW corner (outside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "W corner (outside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "NW corner (outside)"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "N tip"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "NE tip"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "E tip"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "SE tip"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "S tip"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "SW tip"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "W tip"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "NW tip"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "N end"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "NE end"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "E end"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "SE end"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "S end"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "SW end"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "W end"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "NW end"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "Bend"),
    QT_TRANSLATE_NOOP("OpenOrienteering::ControlPropertiesWidget", "Between"),
